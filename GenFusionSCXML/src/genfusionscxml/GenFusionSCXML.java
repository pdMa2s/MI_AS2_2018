...
public class GenFusionSCXML {
    ...
    fg.Complementary(Speech.USER_AMBROSIO, SecondMod.SELF_MUTE, Output.MUTE_AMBROSIO);
    fg.Complementary(Speech.USER_AMBROSIO_IMSERVER, SecondMod.SELF_MUTE, Output.MUTE_AMBROSIO_IMSERVER);
    fg.Complementary(Speech.USER_AMBROSIO, SecondMod.SELF_MUTE_IMSERVER, Output.MUTE_AMBROSIO_IMSERVER);
    fg.Complementary(Speech.USER_AMBROSIO_IMSERVER, SecondMod.SELF_MUTE_IMSERVER, Output.MUTE_AMBROSIO_IMSERVER);
    fg.Complementary(Speech.USER_AMBROSIO_TOPICOS, SecondMod.SELF_MUTE, Output.MUTE_AMBROSIO_TOPICOS);
    fg.Complementary(Speech.USER_AMBROSIO, SecondMod.SELF_MUTE_TOPICOS, Output.MUTE_AMBROSIO_TOPICOS);
    fg.Complementary(Speech.USER_AMBROSIO_TOPICOS, SecondMod.SELF_MUTE_TOPICOS, Output.MUTE_AMBROSIO_TOPICOS);
    fg.Complementary(Speech.USER_AMBROSIO, SecondMod.SELF_DEAF, Output.DEAF_AMBROSIO);
    fg.Complementary(Speech.USER_AMBROSIO_IMSERVER, SecondMod.SELF_DEAF, Output.DEAF_AMBROSIO_IMSERVER);
    fg.Complementary(Speech.USER_AMBROSIO, SecondMod.SELF_DEAF_IMSERVER, Output.DEAF_AMBROSIO_IMSERVER);
    fg.Complementary(Speech.USER_AMBROSIO_IMSERVER, SecondMod.SELF_DEAF_IMSERVER, Output.DEAF_AMBROSIO_IMSERVER);
    fg.Complementary(Speech.USER_AMBROSIO_TOPICOS, SecondMod.SELF_DEAF, Output.DEAF_AMBROSIO_TOPICOS);
    fg.Complementary(Speech.USER_AMBROSIO, SecondMod.SELF_DEAF_TOPICOS, Output.DEAF_AMBROSIO_TOPICOS);
    fg.Complementary(Speech.USER_AMBROSIO_TOPICOS, SecondMod.SELF_DEAF_TOPICOS, Output.DEAF_AMBROSIO_TOPICOS);
    fg.Complementary(Speech.USER_GUSTAVO, SecondMod.SELF_MUTE, Output.MUTE_GUSTAVO);
    fg.Complementary(Speech.USER_GUSTAVO_IMSERVER, SecondMod.SELF_MUTE, Output.MUTE_GUSTAVO_IMSERVER);
    fg.Complementary(Speech.USER_GUSTAVO, SecondMod.SELF_MUTE_IMSERVER, Output.MUTE_GUSTAVO_IMSERVER);
    fg.Complementary(Speech.USER_GUSTAVO_IMSERVER, SecondMod.SELF_MUTE_IMSERVER, Output.MUTE_GUSTAVO_IMSERVER);
    fg.Complementary(Speech.USER_GUSTAVO_TOPICOS, SecondMod.SELF_MUTE, Output.MUTE_GUSTAVO_TOPICOS);
    fg.Complementary(Speech.USER_GUSTAVO, SecondMod.SELF_MUTE_TOPICOS, Output.MUTE_GUSTAVO_TOPICOS);
    fg.Complementary(Speech.USER_GUSTAVO_TOPICOS, SecondMod.SELF_MUTE_TOPICOS, Output.MUTE_GUSTAVO_TOPICOS);
    fg.Complementary(Speech.USER_GUSTAVO, SecondMod.SELF_DEAF, Output.DEAF_GUSTAVO);
    fg.Complementary(Speech.USER_GUSTAVO_IMSERVER, SecondMod.SELF_DEAF, Output.DEAF_GUSTAVO_IMSERVER);
    fg.Complementary(Speech.USER_GUSTAVO, SecondMod.SELF_DEAF_IMSERVER, Output.DEAF_GUSTAVO_IMSERVER);
    fg.Complementary(Speech.USER_GUSTAVO_IMSERVER, SecondMod.SELF_DEAF_IMSERVER, Output.DEAF_GUSTAVO_IMSERVER);
    fg.Complementary(Speech.USER_GUSTAVO_TOPICOS, SecondMod.SELF_DEAF, Output.DEAF_GUSTAVO_TOPICOS);
    fg.Complementary(Speech.USER_GUSTAVO, SecondMod.SELF_DEAF_TOPICOS, Output.DEAF_GUSTAVO_TOPICOS);
    fg.Complementary(Speech.USER_GUSTAVO_TOPICOS, SecondMod.SELF_DEAF_TOPICOS, Output.DEAF_GUSTAVO_TOPICOS);
    fg.Complementary(Speech.USER_MATOS, SecondMod.SELF_MUTE, Output.MUTE_MATOS);
    fg.Complementary(Speech.USER_MATOS_IMSERVER, SecondMod.SELF_MUTE, Output.MUTE_MATOS_IMSERVER);
    fg.Complementary(Speech.USER_MATOS, SecondMod.SELF_MUTE_IMSERVER, Output.MUTE_MATOS_IMSERVER);
    fg.Complementary(Speech.USER_MATOS_IMSERVER, SecondMod.SELF_MUTE_IMSERVER, Output.MUTE_MATOS_IMSERVER);
    fg.Complementary(Speech.USER_MATOS_TOPICOS, SecondMod.SELF_MUTE, Output.MUTE_MATOS_TOPICOS);
    fg.Complementary(Speech.USER_MATOS, SecondMod.SELF_MUTE_TOPICOS, Output.MUTE_MATOS_TOPICOS);
    fg.Complementary(Speech.USER_MATOS_TOPICOS, SecondMod.SELF_MUTE_TOPICOS, Output.MUTE_MATOS_TOPICOS);
    fg.Complementary(Speech.USER_MATOS, SecondMod.SELF_DEAF, Output.DEAF_MATOS);
    fg.Complementary(Speech.USER_MATOS_IMSERVER, SecondMod.SELF_DEAF, Output.DEAF_MATOS_IMSERVER);
    fg.Complementary(Speech.USER_MATOS, SecondMod.SELF_DEAF_IMSERVER, Output.DEAF_MATOS_IMSERVER);
    fg.Complementary(Speech.USER_MATOS_IMSERVER, SecondMod.SELF_DEAF_IMSERVER, Output.DEAF_MATOS_IMSERVER);
    fg.Complementary(Speech.USER_MATOS_TOPICOS, SecondMod.SELF_DEAF, Output.DEAF_MATOS_TOPICOS);
    fg.Complementary(Speech.USER_MATOS, SecondMod.SELF_DEAF_TOPICOS, Output.DEAF_MATOS_TOPICOS);
    fg.Complementary(Speech.USER_MATOS_TOPICOS, SecondMod.SELF_DEAF_TOPICOS, Output.DEAF_MATOS_TOPICOS);
